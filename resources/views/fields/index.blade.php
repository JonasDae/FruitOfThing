...
@section('content')
    <div class="container pt-3">
        <div class="row mt-3 mx-0 font-weight-bold d-none d-md-flex">
            ...
            <div class="col-lg-2 col-md-3">Fruitsoort <a href="{{ route('fruits.index') }}"><i class="fas fa-external-link-alt"></i></a></div>
                ...
                <div class="record">
                    ...
                    <div class="row py-3 mx-0">
                        ...
                        <div class="col-lg-1 col-md-1 col-6">
                            ...
                            <form id="form{{ $field->id }}" action="{{ route('fields.destroy', $field->id) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <a href="javascript:void" onclick="document.getElementById('form{{ $field->id }}').submit();""><i class='far fa-trash-alt text-danger mx-1'></i></a>
                            </form>
                        </div>
                    </div>
                    {{--Accordions--}}
                        ...
                        <div class="row mx-0 px-3">
                            <form action="{{ route('fields.update') }}" method="post" class="w-100 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-4 col-10">
                                        <input id="adres" name="adres" type="text" value="{{ old('adres') ?? $field->adres }}"
                                               class="form-control"
                                               required>
                                    </div>
                                    <div class="col-lg-1 col-md-1 col-2 text-right">
                                        <input id="postcode" name="postcode" type="number" value="{{ old('postcode') ?? $field->postcode }}"
                                               class="form-control"
                                               required>
                                    </div>
