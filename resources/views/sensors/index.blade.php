                ...
                <div class="sensor">
                    <div class="row py-3 mx-0">
                        ...
                        <div class="col-1 text-right">
                            ...
                            <form id="form{{ $sensor->id }}" action="{{ route('sensors.destroy', $sensor->id) }}"
                                  method="post" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <a href="javascript:void"
                                   onclick="document.getElementById('form{{ $sensor->id }}').submit();"><i
                                        class='far fa-trash-alt text-danger mx-1'></i></a>
                            </form>
                        </div>
                    </div>
                </div>
                <div id="collapse{{ $sensor->id }}" class="collapse" aria-labelledby="headingOne"
                    ...
                    <div class="row mx-0 px-3">
                        <form action="{{ route('sensors.update') }}" method="post" class="w-100 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg col-md col-12">
                                    <input name="name_alias" type="text"
                                           value="{{ old('name_alias') ?? $sensor->name_alias }}"
                                           class="form-control"
                                           required>
                                </div>
                                <div class="col-lg col-md col-12">
                                    <input name="measuring_unit" type="text"
                                ...
                                <div class="col-lg col-md col-12">
                                    <input name="graph_type" type="text"
                                           value="{{ old('graph_type') ?? $sensor->graph_type }}"
                                           class="form-control"
                                           required>
                                </div>
                                <div class="col-lg-1 col-md-1 col text-right">
